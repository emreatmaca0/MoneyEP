...
<div style="display: flex; flex-wrap: wrap; justify-content: center;align-items: flex-start;">
    <div class="card" style="display: inline-block;padding: 27px;margin: 31px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor" style="margin: 3;color: #71dd37;font-size: 53px;">
    ...
    <div class="card" style="display: inline-block;padding: 27px;margin: 31px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor" style="margin: 3;color: #696CFF;font-size: 53px;">
            <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
        ...
        <p class="text-muted" style="font-size: 20px;margin-bottom: 0px;margin-left: 3px;">Varlıklarım</p>
    ...
    <div class="card" style="display: inline-block;padding: 27px;margin: 31px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor" style="margin: 3;color: #FF3E1D;font-size: 53px;">
            <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
        ...
        <p class="text-muted" style="font-size: 20px;margin-bottom: 0px;margin-left: 3px;">Aylık Gider</p>
    ...
    <div class="card" style="display: inline-block;padding: 27px;margin: 31px;border-radius: 15px;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor" style="margin: 3;color: #03C3EC;font-size: 53px;">
        ...
        <p class="text-muted" style="font-size: 20px;margin-bottom: 0px;margin-left: 3px;">Borçlarım</p>
...
<div style="display: flex; flex-wrap: wrap; justify-content: space-around;align-items: flex-start;">
    ...
    <div class="chart-container" style="position: relative; height:60vh; width:40vw; padding-bottom: 60px;">
        <h2 class="" style="padding: 5px; color: #566A7F;">Harcama Türleri</h2>
